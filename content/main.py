...
<section id="stations">
<h2>지하철역 인근 안내</h2>
<p>지하철역별 안내는 동작구를 지나는 1·4·7·9호선과 신림선의 주요 역세권을 기준으로 구성합니다. 각 역 페이지에서는 인근 생활권, 주변 대표 동, 예약 가능 시간, 방문 전 준비사항을 설명하며, 출구별 페이지나 역과 테마를 조합한 페이지는 만들지 않습니다. 환승역은 노선이 여러 개라도 페이지는 하나로 운영합니다.</p>
<ul class="card-grid">
